define(function(require) {
    ...
    var arr = require('arr');
    var staticMethod = require('staticMethod');
    var inherit = require('inherit');

    var each = staticMethod.each;
    var extend = staticMethod.extend;
    var isObject = staticMethod.isObject;
    var isArray = staticMethod.isArray;
    var isFunction = staticMethod.isFunction;
    var isString = staticMethod.isString;
    var push = arr.push;
    var slice = arr.slice;
